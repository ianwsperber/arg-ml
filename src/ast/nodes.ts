...
export type CredenceValue = { kind: "bucket"; value: string } | { kind: "numeric"; value: number };

export type StrengthValue = { kind: "bucket"; value: string } | { kind: "numeric"; value: number };
